...
/// 뱃지·타이틀 구조를 개편하기 전까지 리더보드 엠블럼, 통계 페이지 칭호,
/// 순위 업적(국가/글로벌) 계산을 숨긴다. 생존 업적은 캐릭터 해금에 쓰이므로 유지.
/// 개편 후 이 플래그와 분기를 함께 제거할 것 (2026-09-18).
const bool kShowAchievementBadges = false;
